    ...
    <form method="POST" action="" enctype="multipart/form-data">
      <table align="center">
        <tr>
          ...
          <td><input type="text" name="classe" id="classe" value="<?php if (isset($classe)) {
                                                                    echo $classe;
                                                                  } ?>"></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="text" name="nbreleve" id="nbreleve" value="<?php if (isset($classe)) {
                                                                        echo $classe;
                                                                      } ?>"></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="text" name="censeur" id="censeur" value="<?php if (isset($classe)) {
                                                                      echo $classe;
                                                                    } ?>"></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="text" name="chef" id="chef" value="<?php if (isset($chef_classe)) {
                                                                echo $chef_classe;
                                                              } ?>"></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="text" name="prof_principale" id="prof_principale" value="<?php if (isset($prof_principale)) {
                                                                                      echo $prof_principale;
                                                                                    } ?>"></td>
        </tr>

        <tr>
          <td align="left"><label for="matricule">Votre matricule :</label></td>
          <td><input type="text" name="matricule" id="matricule" value="<?php if (isset($matricule)) {
                                                                          echo $matricule;
                                                                        } ?>"></td>
        </tr>
