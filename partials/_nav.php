    ...
    <nav class="navbar navbar-expand bg-dark navbar-light sticky-top px-4 py-0">
        ...
        <ul class="navbar-nav">
            <div class="nav-item dropdown d-none d-lg-flex ">
                <a href="#" class="nav-link dropdown-toggle text-white" data-bs-toggle="dropdown">Emploi de Temps</a>
            ...
            <li class="nav-item  d-none d-lg-flex text-white">
                <a class="nav-link text-white" href="stats_cours.php">
                    Statistiques
                </a>
            </li>
